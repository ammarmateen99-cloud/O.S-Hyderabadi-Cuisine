...
├─ images/             ← Placeholder images for dishes
│    ├─ hero.jpg
│    ├─ mutton-talawa.jpg
│    ├─ mutton-hari-mirchi.jpg
│    ├─ mutton-kali-mirchi.jpg
│    ├─ mutton-bhunawa.jpg
│    ├─ mutton-badami.jpg
│    ├─ mutton-punjabi.jpg
│    ├─ mutton-masala.jpg
...
│    ├─ chicken-lagan.jpg
│    ├─ chicken-rogan.jpg
│    ├─ chicken-schezwan.jpg
│    └─ chicken-tandoori-masala.jpg
<!DOCTYPE html>
<html lang="en">
<head>
  <meta charset="UTF-8">
...
<body>
  ...
  <section id="menu">
    ...
    <div class="menu-grid">
      ...
      <div class="menu-card">
        <img src="images/mutton-kali-mirchi.jpg" alt="Mutton Kali Mirchi">
        <h3>Mutton Kali Mirchi</h3>
        <p>Peppery black chili mutton, rich and flavorful.</p>
      </div>
      <div class="menu-card">
        <img src="images/mutton-bhunawa.jpg" alt="Mutton Bhunawa">
        <h3>Mutton Bhunawa</h3>
        <p>Slow-cooked mutton with traditional bhunawa spices.</p>
      </div>
      <div class="menu-card">
        <img src="images/mutton-badami.jpg" alt="Mutton Badami">
        <h3>Mutton Badami</h3>
        <p>Rich almond-flavored mutton for royal taste.</p>
      </div>
      <div class="menu-card">
        <img src="images/mutton-punjabi.jpg" alt="Mutton Punjabi">
        <h3>Mutton Punjabi</h3>
        <p>Classic Punjabi-style mutton, aromatic and spicy.</p>
      </div>
      <div class="menu-card">
        <img src="images/mutton-masala.jpg" alt="Mutton Masala">
        <h3>Mutton Masala</h3>
        <p>Mutton cooked with a rich, spicy masala gravy.</p>
      </div>
      <div class="menu-card">
        <img src="images/mutton-zafrani.jpg" alt="Mutton Zafrani">
        <h3>Mutton Zafrani</h3>
        <p>Mutton delicately flavored with saffron and spices.</p>
      </div>
      <div class="menu-card">
        <img src="images/mutton-bhendi.jpg" alt="Mutton Bhendi">
        <h3>Mutton Bhendi</h3>
        <p>Mutton cooked with okra and traditional spices.</p>
      </div>
      ...
      <div class="menu-card">
        <img src="images/chicken-schezwan.jpg" alt="Chicken Schezwan">
        <h3>Chicken Schezwan</h3>
        <p>Spicy Schezwan-style chicken with bold flavors.</p>
      </div>
      <div class="menu-card">
        <img src="images/chicken-tandoori-masala.jpg" alt="Chicken Tandoori Masala">
        <h3>Chicken Tandoori Masala</h3>
        <p>Grilled chicken marinated in traditional tandoori spices.</p>
      </div>
